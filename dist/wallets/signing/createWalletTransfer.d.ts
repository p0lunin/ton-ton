...
import { Wallet4PluginArgsSignable, Wallet4PluginArgsSigned, Wallet4SendArgsSignable, Wallet4SendArgsSigned } from "../WalletContractV4";
...
export declare function createWalletPluginActionV4<T extends Wallet4PluginArgsSigned | Wallet4PluginArgsSignable>(args: T & {
    sendMode: number;
    walletId: number;
}): T extends Wallet4PluginArgsSignable ? Promise<Cell> : Cell;
