...
import { WalletV4ExtendedSendArgsSignable, WalletV4ExtendedSendArgsSigned } from "../v4/WalletContractV4Actions";
...
export declare function createWalletTransferV4<T extends WalletV4ExtendedSendArgsSigned | WalletV4ExtendedSendArgsSignable>(args: T & {
    walletId: number;
}): T extends WalletV4ExtendedSendArgsSignable ? Promise<Cell> : Cell;
