...
exports.createWalletPluginActionV4 = createWalletPluginActionV4;
...
function createWalletPluginActionV4(args) {
    let signingMessage = (0, core_1.beginCell)()
        .storeUint(args.walletId, 32);
    if (args.seqno === 0) {
        for (let i = 0; i < 32; i++) {
    ...
    switch (args.pluginAction.action) {
        case 'deployAndInstall':
            ...
            signingMessage.storeRef((0, core_1.beginCell)().store((0, core_1.storeStateInit)(args.pluginAction.stateInit)));
