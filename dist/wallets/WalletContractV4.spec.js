...
describe('WalletContractV4', () => {
    ...
    describe('plugins', () => {
        ...
        beforeEach(() => {
            ...
            extensionContract = client.open(WalletContractV4_1.WalletContractV4.create({ workchain: 0, publicKey: walletKey.publicKey }));
        ...
        it('should withdraw funds by extension request', async () => {
            let seqno = await contract.getSeqno();
            await extensionContract.sendPluginRequestFunds(extensionContract.sender(walletKey.secretKey), {
                forwardAmount: (0, core_1.toNano)('0.01'),
        ...
        it('should delete extension by extension request', async () => {
            ...
            await extensionContract.sendPluginRemovePlugin(extensionContract.sender(walletKey.secretKey), (0, core_1.toNano)('0.01'));
            await (0, testWallets_1.tillNextSeqno)(contract, seqno);
        });
    });
});
